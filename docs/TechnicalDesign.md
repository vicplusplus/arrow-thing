...
- **`LobbyService`** — REST + DB access for lobbies. CRUD, status lookup, rate-limited create (5 per 30 min per user, global generation concurrency = 1), `MinBoardDimension = 100`, `MaxBoardDimension = 400` validation for client-supplied sizes.
